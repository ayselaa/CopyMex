...
using Mechanic.Service.Services;
...
//builder.Services.AddIdentity<AppUser, IdentityRole>().AddEntityFrameworkStores<AppDbContext>().AddDefaultTokenProviders();  //kohne versiyasidi
...
builder.Services.AddSingleton<ISoapFinService, Service1SoapClient>();
builder.Services.AddScoped<ICheckFIN, CheckFINService>();
